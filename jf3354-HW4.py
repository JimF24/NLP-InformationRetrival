...
for word in IDF_query_collection:
    IDF_query_collection[word] = math.log((len(queries)/IDF_query_collection[word])+1,2)
...
for word in IDF_abstract_collection:
    IDF_abstract_collection[word] = math.log((len(abstract)/IDF_abstract_collection[word])+1,2)
